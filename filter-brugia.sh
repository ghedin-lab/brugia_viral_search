#!/bin/bash
#PBS -l walltime=120:00:00,nodes=1:ppn=20,mem=62gb
...
path="/scratch/at120/brugia-rnaseq/brugia_viral_search/filtered-data"
cd $path

#fastq="test"

# set this to the directory where the custom python scripts are located. Will hopefully automate this later
exec_path="/scratch/at120/brugia-rnaseq/brugia_viral_search/scripts"
...
perl /scratch/at120/apps/deconseq-standalone-0.4.3/deconseq.pl -id $fastq.non-rRNA.deconseq -f $fastq.non-rRNA.fastq -dbs brugia_16s
